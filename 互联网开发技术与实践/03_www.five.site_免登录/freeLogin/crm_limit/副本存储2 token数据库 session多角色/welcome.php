...
<html>
    ...
    <body>
        ...
        //学生可以访问的页面
    foreach($_SESSION['role_id'] as $val){
        ...
        if($val==1)
        {
            ...
            <html>
                ...
                <a href="http://101.200.78.125:805/freeLogin/crm_limit/diffRolePage/studentPage3.php" target="_blank">studentPage3</a><br><br>
        ...
        else if($val==2)
        {
            ...
            <html>
                ...
                <a href="http://101.200.78.125:805/freeLogin/crm_limit/diffRolePage/teacherPage3.php" target="_blank">teacherPage3</a><br><br>
        ...
        else if($val==3)
        {
            ...
            <html>
                ...
                <a href="http://101.200.78.125:805/freeLogin/crm_limit/diffRolePage/adminPage3.php" target="_blank">adminPage3</a><br><br>
